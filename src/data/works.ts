...
export const MyWorksNew = [
    {
        ...
        period: "2022 — Present",
        description: "Design, build and maintain backend application of Komcards, a virtual debit card solution for online business trusted by more than 14,700 users. " +
            "Participated in the architectural transformation of Komship, shifting from a monolith to a microservices ecosystem. Conducted sharing sessions on competitive programming to upskill the engineering team.",
    ...
    {
        title: "Software Engineer - Atmatech Global Informatika",
        url: "https://netray.id/",
        period: "2018 — 2022",
    ...
    {
        title: "Freelance Fullstack Engineer - Rasabaik",
